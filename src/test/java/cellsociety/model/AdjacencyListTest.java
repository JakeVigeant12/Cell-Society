...
public class AdjacencyListTest {
  ...
  private AdjacencyList adjList = new AdjacencyList(grid,
      Map.of(c1.getId(), c1, c2.getId(), c2, c3.getId(), c3, c4.getId(), c4, c5.getId(), c5,
          c6.getId(), c6, c7.getId(), c7, c8.getId(), c8, c9.getId(), c9), full);
