...
public class Histogram {
  ...
  public void makeBarGraph() {
    ...
    cellKeys.forEach((n) -> {
      barSeries.getData()
          .add(new XYChart.Data<String, Integer>("State " + n, (Integer) cellNumbers.get(n), true));
    });
  ...
  public void makeLineGraph(Timeline time) {
    ...
    cellKeys.forEach((n) -> {
      ...
      SERIES_LIST.get((Integer) n).getData()
          .add(new XYChart.Data<Number, Integer>(0, (Integer) cellNumbers.get(n), true));
  ...
  public void updateLineGraph(Timeline timeline) {
    ...
    cellKeys.forEach((n) -> {
      ...
      SERIES_LIST.get((Integer) n).getData()
          .add(new XYChart.Data<Number, Integer>(updateTime, (Integer) cellNumbers.get(n), true));
    });
  }
